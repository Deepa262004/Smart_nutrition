...
from .views import signup, get_user_details,predict_diet,login_view,profile_setup,get_user_profile,ingredient_substitute_view,get_choices,update_profile
